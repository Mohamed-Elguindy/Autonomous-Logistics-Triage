...
def format_node(state: AgentState):
    ...
    for idx, draft in enumerate(drafts):
        ...
        action = RecommendedAction(
            ...
            new_destination=draft.get("new_destination", req.destination.name),
            destination_lat=draft.get("destination_lat", req.destination.lat),
            destination_lng=draft.get("destination_lng", req.destination.lng),
            new_eta=new_eta,
